...
public class TicketResultActivity extends AppCompatActivity {
  ...
  private void searchBarcode(String barcode) {
    ...
    JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, URL + barcode, null,
  ...
  private void renderMovie(JSONObject response) {
    try {
      ...
      showNoTicket();
      Toast.makeText(getApplicationContext(), "Error occurred. Check your LogCat for full report",
  ...
  private class Movie {
    ...
    @SerializedName("released") boolean isReleased;
