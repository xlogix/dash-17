...
public class MainActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        Log.d(TAG + " handler", rawResult.getBarcodeFormat().toString()); // Prints the scan format (QR_Code)
        Toast.makeText(this, "Captured Data: " + rawResult.toString(), Toast.LENGTH_LONG).show(); // Shows the result to user
        MediaPlayer mPlayer = MediaPlayer.create(MainActivity.this, R.raw.scan);
        mPlayer.start();

        Intent mainToDetail = new Intent(MainActivity.this, DetailsActivity.class).putExtra("code", rawResult.getText());
