...
public class ScanActivity extends AppCompatActivity implements BarcodeReader.BarcodeReaderListener {
  ...
  @Override public void onScanned(Barcode barcode) {
  ...
  @Override public void onScannedMultiple(List<Barcode> list) {
  ...
  @Override public void onScanError(String s) {
    Toast.makeText(getApplicationContext(), "Error occurred while scanning " + s,
