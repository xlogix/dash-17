...
public class MainActivity2 extends AppCompatActivity implements ZXingScannerView.ResultHandler {
  ...
  @Override public void handleResult(Result rawResult) {
    ...
    MediaPlayer mPlayer = MediaPlayer.create(MainActivity2.this, R.raw.scan);
    mPlayer.start();

    Intent mainToDetail =
        new Intent(MainActivity2.this, DetailsActivity.class).putExtra("code", rawResult.getText());
