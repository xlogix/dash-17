...
public class DetailsActivity extends Activity {
    ...
    TextView userID, userName, userPhoneNo, userCollege, userEmail, userRegistrationNo, userDepartment, userYear, userEvents;
    Button att, scan;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.red_primary, R.color.black, R.color.blue_primary);
    ...
    private void mark(final String code) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                AppConfig.UPDATE_URL, new Response.Listener<String>() {
    ...
    void addUse(String id, String name, String email, String phone, String coll, String regis, String dept, String year, String evn, String a) {
        userID.setText(id);
        ...
        for (int k = 0; k < events.length; k++) {
            ...
            tb[k] = new ToggleButton(getApplicationContext());
